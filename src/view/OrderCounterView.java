...
public class OrderCounterView {
    ...
    public static void displayOrderList(ItemProduct[] menuList) {
        ...
        for (int i = 0; i < 21; i++) {
            // System.out.printf("| " + (i+1) + " | " + menuList[i].getName() + " | "+
            // menuList[i].getPrice() +" |\n");
            System.out.println(String.format("%-1s %-2s %-1s %-43s %-1s %.2f %-2s", "|", (i + 1), "|",
                    menuList[i].getName(), "|", menuList[i].getPrice(), "      |"));
            System.out.println("+----+---------------------------------------------+------------+");
        }
    }

    public static void displayItemProductLst(List<ItemProduct> itemProducts) {
